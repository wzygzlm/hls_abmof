...
entity parseEvents_mux_2bck is
generic (
    ID            :integer := 0;
    NUM_STAGE     :integer := 1;
...
architecture rtl of parseEvents_mux_2bck is
    -- puts internal signals
    signal sel    : std_logic_vector(15 downto 0);
    -- level 1 signals
    signal mux_1_0    : std_logic_vector(179 downto 0);
    signal mux_1_1    : std_logic_vector(179 downto 0);
    signal mux_1_2    : std_logic_vector(179 downto 0);
    signal mux_1_3    : std_logic_vector(179 downto 0);
    signal mux_1_4    : std_logic_vector(179 downto 0);
    signal mux_1_5    : std_logic_vector(179 downto 0);
    signal mux_1_6    : std_logic_vector(179 downto 0);
    signal mux_1_7    : std_logic_vector(179 downto 0);
    signal mux_1_8    : std_logic_vector(179 downto 0);
    signal mux_1_9    : std_logic_vector(179 downto 0);
    -- level 2 signals
    signal mux_2_0    : std_logic_vector(179 downto 0);
    signal mux_2_1    : std_logic_vector(179 downto 0);
    signal mux_2_2    : std_logic_vector(179 downto 0);
    signal mux_2_3    : std_logic_vector(179 downto 0);
    signal mux_2_4    : std_logic_vector(179 downto 0);
    -- level 3 signals
    signal mux_3_0    : std_logic_vector(179 downto 0);
    signal mux_3_1    : std_logic_vector(179 downto 0);
    signal mux_3_2    : std_logic_vector(179 downto 0);
    -- level 4 signals
    signal mux_4_0    : std_logic_vector(179 downto 0);
    signal mux_4_1    : std_logic_vector(179 downto 0);
    -- level 5 signals
    signal mux_5_0    : std_logic_vector(179 downto 0);
    -- level 6 signals
    signal mux_6_0    : std_logic_vector(179 downto 0);
    -- level 7 signals
    signal mux_7_0    : std_logic_vector(179 downto 0);
    -- level 8 signals
    signal mux_8_0    : std_logic_vector(179 downto 0);
    -- level 9 signals
    signal mux_9_0    : std_logic_vector(179 downto 0);
    -- level 10 signals
    signal mux_10_0    : std_logic_vector(179 downto 0);
    -- level 11 signals
    signal mux_11_0    : std_logic_vector(179 downto 0);
    -- level 12 signals
    signal mux_12_0    : std_logic_vector(179 downto 0);
    -- level 13 signals
    signal mux_13_0    : std_logic_vector(179 downto 0);
    -- level 14 signals
    signal mux_14_0    : std_logic_vector(179 downto 0);
    -- level 15 signals
    signal mux_15_0    : std_logic_vector(179 downto 0);
    -- level 16 signals
    signal mux_16_0    : std_logic_vector(179 downto 0);
begin
