...
#include "parseEvents_glPLSeOg.h"
...
struct parseEvents : public sc_module {
    ...
    parseEvents_glPLSeOg* glPLSlices_V_0_U;
    parseEvents_glPLSeOg* glPLSlices_V_1_U;
    parseEvents_glPLSeOg* glPLSlices_V_2_U;
    parseEvents_glPLSeOg* glPLSlices_V_3_U;
    parseEvents_glPLSeOg* glPLSlices_V_4_U;
    parseEvents_glPLSeOg* glPLSlices_V_5_U;
    parseEvents_glPLSeOg* glPLSlices_V_6_U;
    parseEvents_glPLSeOg* glPLSlices_V_7_U;
    parseEvents_glPLSeOg* glPLSlices_V_8_U;
    parseEvents_glPLSeOg* glPLSlices_V_9_U;
    parseEvents_glPLSeOg* glPLSlices_V_10_U;
    parseEvents_glPLSeOg* glPLSlices_V_11_U;
    parseEvents_glPLSeOg* glPLSlices_V_12_U;
    parseEvents_glPLSeOg* glPLSlices_V_13_U;
    parseEvents_glPLSeOg* glPLSlices_V_14_U;
    parseEvents_glPLSeOg* glPLSlices_V_15_U;
    calcOF* grp_calcOF_fu_1565;
    parseEvents_mux_1bkb<1,1,36,36,36,36,36,36,36,36,36,36,36,36,36,36,36,36,4,36>* parseEvents_mux_1bkb_U110;
    ...
    sc_signal< bool > ap_block_state22_pp0_stage18_iter0_ignore_call0;
    ...
    void thread_ap_block_state22_pp0_stage18_iter0_ignore_call0();
