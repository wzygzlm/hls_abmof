...
#ifndef __parseEvents_sub_2cud__HH__
#define __parseEvents_sub_2cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(parseEvents_sub_2cud) {
    ...
    SC_CTOR(parseEvents_sub_2cud):  ACMP_sub_comb_U ("ACMP_sub_comb_U") {
