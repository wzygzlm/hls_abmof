...
#ifndef __parseEvents_mul_mbbk__HH__
#define __parseEvents_mul_mbbk__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(parseEvents_mul_mbbk) {
    ...
    SC_CTOR(parseEvents_mul_mbbk):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
