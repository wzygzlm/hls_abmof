...
void sum(ap_int<BITS_PER_PIXEL> refBlock[BLOCK_SIZE][BLOCK_SIZE], ap_int<BITS_PER_PIXEL> targetBlocks[BLOCK_SIZE][BLOCK_SIZE], int16_t * sum)
{
	int16_t retVal = 0;
